function [bestSolution, bestFitness, iteration]=GJO_case5(fhd, dimension, maxIteration, fNumber)
        ...
        for j=1:size(Positions,2)     
           ...
           E=E1*E0; % Evading energy
             ...
             if abs(E)<1
               ...
               D_male_jackal = abs((RL(i, j) * Male_Jackal_pos(j) - randomPosition(j))); 
            Male_Positions(i, j) = Male_Jackal_pos(j) - E * D_male_jackal;
            D_female_jackal = abs((RL(i, j) * Female_Jackal_pos(j) - randomPosition(j))); 
