function [bestSolution, bestFitness, iteration]=GJO_case9(fhd, dimension, maxIteration, fNumber)
           ...
           E=E1*E0; % Evading energy
             ...
             if abs(E)<1
               %% EXPLOITATION
                ...
                % Use a different strategy for the female jackal, e.g., using a random jackal
