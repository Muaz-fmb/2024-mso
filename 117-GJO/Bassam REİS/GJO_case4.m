function [bestSolution, bestFitness, iteration]=GJO_case4(fhd, dimension, maxIteration, fNumber)
           ...
           E=E1*E0; % Evading energy
             ...
             if abs(E)<1
               ...
               D_male_jackal=abs((RL(i,j)*Male_Jackal_pos(j)-Positions(index,j))); 
                ...
                D_female_jackal=abs((RL(i,j)*Female_Jackal_pos(j)-Positions(index,j))); 
