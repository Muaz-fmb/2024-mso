function [bestSolution, bestFitness, iteration]=cmaes_case_3(fhd, dimension, maxIteration, fNumber)
...
% New randomized selection:
M(1).Position = VarMin + (VarMax - VarMin) .* rand(VarSize);
